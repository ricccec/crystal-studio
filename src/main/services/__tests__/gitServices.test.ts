...
describe('gitServices', () => {
    ...
    describe('checkGit', () => {
        it('should return git version on success', async () => {
            ...
            const result = await gitService.checkGit();

            expect(result).toEqual({
                ok: true,
                data: 'git version 2.42.0'
            });
        ...
        it('should return error when git command is canceled', async () => {
            const mockResult: SpawnResult = {
                status: 'canceled',
                signal: 'SIGTERM',
                stderr: ''
        ...
        it('should handle canceled status without signal', async () => {
            const mockResult: SpawnResult = {
                status: 'canceled',
                stderr: ''
            };
